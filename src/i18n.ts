...
const en: Dict = {
  ...
  "settings.credNote":
    "Auto-discover silently reuses the logins your AI CLIs keep on this PC. Explicit only never opens those files — cards appear just for keys you add in Pane (API keys and named accounts).",
  "settings.windowPosLabel": "Window position",
  "settings.resetPos": "Reset to tray",
  "settings.accounts": "Named accounts",
  "settings.accountsNote":
    "Paste several account keys per provider and name each one — every account gets its own card. Keys stay only on this PC (%APPDATA%\\Pane\\accounts).",
  "settings.accountsNamePh": "Name (e.g. Work)",
  "settings.accountsKeyPhKimi": "Kimi For Coding plan key",
  "settings.accountsKeyPhOpenCode": "OpenCode Go plan key",
  "settings.accountsKeyPhGlmCn": "GLM Coding Plan key (bigmodel.cn)",
  "settings.accountsAdd": "Add",
  "settings.accountsRename": "Rename",
  "settings.accountsDelete": "Delete",
  "settings.accountsCancel": "Cancel",
  "settings.accountsSave": "Save",
  "settings.cursorLoginNote":
    "Sign in with your browser — no Cursor install needed. Tokens stay on this PC.",
  "settings.cursorLoginBtn": "Sign in",
  "settings.cursorLoginWaitingBtn": "Waiting…",
  "settings.cursorLogoutBtn": "Log out",
  "settings.cursorSignedIn": "Signed in",
  "settings.cursorSignedOut": "Not signed in",
  "footer.cursorLoginWaiting": "Browser opened — finish signing in to Cursor…",
  "footer.cursorLoginDone": "Cursor signed in",
  "footer.cursorLoginTimeout": "Cursor login timed out — try again",
  "footer.cursorLoginFailed": "Cursor login failed: {err}",
  "card.loginCta": "Sign in",
  "card.addAccountCta": "Add account",
  "settings.displayMode": "Display mode",
  "settings.displayStandard": "Cards",
  "settings.displayMinimal": "Minimal",
  "footer.accountNeedBoth": "Enter both a name and a key",
  "footer.accountSaved": "Account {name} saved",
  "footer.accountRenamed": "Renamed to {name}",
  "footer.accountDeleted": "Account removed",
  "footer.accountSaveFailed": "Could not save account: {err}",
  "footer.windowPosReset": "Window position reset — opens by the tray again",
...
const zh: Dict = {
  ...
  "settings.credNote":
    "自动发现会静默复用你电脑上各 AI 命令行工具保存的登录信息。仅显式登录则完全不读取那些文件——只显示你在 Pane 里主动添加的密钥（API 密钥和命名账号）。",
  "settings.windowPosLabel": "窗口位置",
  "settings.resetPos": "重置到托盘",
  "settings.accounts": "命名账号",
  "settings.accountsNote":
    "每家可添加多个账号密钥并分别命名，每个账号单独出一张卡。密钥只保存在本机（%APPDATA%\\Pane\\accounts）。",
  "settings.accountsNamePh": "名称（如：工作号）",
  "settings.accountsKeyPhKimi": "Kimi For Coding 套餐密钥",
  "settings.accountsKeyPhOpenCode": "OpenCode Go 套餐密钥",
  "settings.accountsKeyPhGlmCn": "GLM Coding Plan 密钥（bigmodel.cn）",
  "settings.accountsAdd": "添加",
  "settings.accountsRename": "重命名",
  "settings.accountsDelete": "删除",
  "settings.accountsCancel": "取消",
  "settings.accountsSave": "保存",
  "settings.cursorLoginNote":
    "用浏览器登录——无需安装 Cursor。凭据只保存在本机。",
  "settings.cursorLoginBtn": "登录",
  "settings.cursorLoginWaitingBtn": "等待中…",
  "settings.cursorLogoutBtn": "退出登录",
  "settings.cursorSignedIn": "已登录",
  "settings.cursorSignedOut": "未登录",
  "footer.cursorLoginWaiting": "已打开浏览器——请在页面完成 Cursor 登录…",
  "footer.cursorLoginDone": "Cursor 登录成功",
  "footer.cursorLoginTimeout": "Cursor 登录超时——请重试",
  "footer.cursorLoginFailed": "Cursor 登录失败：{err}",
  "card.loginCta": "登录",
  "card.addAccountCta": "添加账号",
  "settings.displayMode": "显示模式",
  "settings.displayStandard": "卡片",
  "settings.displayMinimal": "极简",
  "footer.accountNeedBoth": "请填写名称和密钥",
  "footer.accountSaved": "账号 {name} 已保存",
  "footer.accountRenamed": "已重命名为 {name}",
  "footer.accountDeleted": "账号已删除",
  "footer.accountSaveFailed": "账号保存失败：{err}",
  "footer.windowPosReset": "窗口位置已重置，将在托盘旁打开",
...
const ru: Dict = {
  ...
  "settings.credNote":
    "Автообнаружение незаметно переиспользует логины ваших AI-CLI на этом ПК. Режим «только явные» не открывает эти файлы — карточки появляются только для ключей, добавленных в Pane (API-ключи и именованные аккаунты).",
  "settings.windowPosLabel": "Положение окна",
  "settings.resetPos": "Сбросить к трею",
  "settings.accounts": "Именованные аккаунты",
  "settings.accountsNote":
    "Добавьте несколько ключей для каждого провайдера и назовите каждый — каждому аккаунту своя карточка. Ключи хранятся только на этом ПК (%APPDATA%\\Pane\\accounts).",
  "settings.accountsNamePh": "Название (напр. Работа)",
  "settings.accountsKeyPhKimi": "Ключ плана Kimi For Coding",
  "settings.accountsKeyPhOpenCode": "Ключ плана OpenCode Go",
  "settings.accountsKeyPhGlmCn": "Ключ GLM Coding Plan (bigmodel.cn)",
  "settings.accountsAdd": "Добавить",
  "settings.accountsRename": "Переименовать",
  "settings.accountsDelete": "Удалить",
  "settings.accountsCancel": "Отмена",
  "settings.accountsSave": "Сохранить",
  "settings.cursorLoginNote":
    "Войдите через браузер — Cursor устанавливать не нужно. Токены хранятся на этом ПК.",
  "settings.cursorLoginBtn": "Войти",
  "settings.cursorLoginWaitingBtn": "Ожидание…",
  "settings.cursorLogoutBtn": "Выйти",
  "settings.cursorSignedIn": "Выполнен вход",
  "settings.cursorSignedOut": "Вход не выполнен",
  "footer.cursorLoginWaiting": "Браузер открыт — завершите вход в Cursor…",
  "footer.cursorLoginDone": "Вход в Cursor выполнен",
  "footer.cursorLoginTimeout": "Время входа в Cursor истекло — попробуйте снова",
  "footer.cursorLoginFailed": "Не удалось войти в Cursor: {err}",
  "card.loginCta": "Войти",
  "card.addAccountCta": "Добавить аккаунт",
  "settings.displayMode": "Режим отображения",
  "settings.displayStandard": "Карточки",
  "settings.displayMinimal": "Минимум",
  "footer.accountNeedBoth": "Введите название и ключ",
  "footer.accountSaved": "Аккаунт {name} сохранён",
  "footer.accountRenamed": "Переименован в {name}",
  "footer.accountDeleted": "Аккаунт удалён",
  "footer.accountSaveFailed": "Не удалось сохранить аккаунт: {err}",
  "footer.windowPosReset": "Положение окна сброшено — снова откроется у трея",
